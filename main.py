...
with mp_hand.Hands(min_detection_confidence=0.5,
 ...
 2, (255, 0, 0), 5)
 cv2.putText(image, "LED1 ON", (100, 375), cv2.FONT_HERSHEY_SIMPLEX,
 2, (255, 0, 0), 5)
 elif total==2:
 cv2.rectangle(image, (20, 300), (400, 425), (0, 255, 0), cv2.FILLED)
 cv2.putText(image, "2", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
 2, (255, 0, 0), 5)
 cv2.putText(image, "LED2 ON", (100, 375), cv2.FONT_HERSHEY_SIMPLEX,
 2, (255, 0, 0), 5)
 elif total==3:
 cv2.rectangle(image, (20, 300), (400, 425), (0, 255, 0), cv2.FILLED)
 cv2.putText(image, "3", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
 2, (255, 0, 0), 5)
 cv2.putText(image, "LED1 OFF", (100, 375), cv2.FONT_HERSHEY_SIMPLEX,
 2, (255, 0, 0), 5)
 elif total==4:
 cv2.rectangle(image, (20, 300), (400, 425), (0, 255, 0), cv2.FILLED)
 cv2.putText(image, "4", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
 2, (255, 0, 0), 5)
 cv2.putText(image, "LED2 OFF", (100, 375), cv2.FONT_HERSHEY_SIMPLEX,
 2, (255, 0, 0), 5)
 elif total==5:
 cv2.rectangle(image, (20, 300), (400, 425), (0, 255, 0), cv2.FILLED)
